...
public record struct Bounds3I
{
	...
	public Bounds3I Abs()
	{
		var lowest = MathV.Min(Position, End);
		var highest = MathV.Max(Position, End);

		Position = lowest;
		End = highest;
		return this;
	}
	public readonly bool Encloses(Bounds3I bounds)
	{
		return Position <= bounds.Position && bounds.End <= End;
	}
	public Bounds3I Expand(Vector3I to)
	{
		var lowest = MathV.Min(Position, to);
		var highest = MathV.Max(End, to);
		Position = lowest;
		End = highest;
		return this;
	}
	public readonly Vector3I GetCenter()
	{
		return Position + (Size / 2);
	}
	public readonly bool HasPoint(Vector3I point)
	{
		return point >= Position && point <= End;
	}
	#endregion
}
